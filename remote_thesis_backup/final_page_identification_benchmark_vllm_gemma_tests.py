...
from final_page_identification_vllm_gemma_tests import PageIdentificationBenchmarkLLM, BinaryStringClassifier, FourClassStringClassifier
...
def main(model_name, classifier_type, test_run, n_loops, verbose, combine_system_prompts, no_think, tensor_parallel_size, batched, enforce_eager):
    ...
    if test_run:
        ...
        for t in all_types:
            ...
            sample.extend(random.sample(entries_of_type, 7))
