...
def main(model_name, classifier_type, test_run, n_loops, verbose, combine_system_prompts, no_think, tensor_parallel_size, batched, gpu):
    ...
    if test_run:
        ...
        for t in all_types:
            ...
            sample.extend(random.sample(entries_of_type, 25))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gpu", type=str, default="a100", help="GPU to use for the benchmark")
    args = parser.parse_args()
    print(f"Running benchmark with model: {args.model_name}, classifier: {args.classifier}, test_run: {args.test_run}, n_loops: {args.n_loops}, verbose: {args.verbose}, combine_system_prompts: {args.combine_system_prompts}, no_think: {args.no_think}, tensor_parallel_size: {args.tensor_parallel_size}, batched: {args.batched}, gpu: {args.gpu}")
    main(args.model_name, args.classifier, args.test_run, args.n_loops, args.verbose, args.combine_system_prompts, args.no_think, args.tensor_parallel_size, args.batched, args.gpu)