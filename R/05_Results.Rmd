...
@liExtractingFinancialData2023 describes two ways to identify the relevant pages
...
decreasing the recall. This regular expression is called *exhausitve regex restricted*. The regular expressions can be found in the appendix
...
understanding capabilities of \acr{LLM}s. @liExtractingFinancialData2023 use this
...
-   @liExtractingFinancialData2023 did not report any issues with this approach.
...
@liExtractingFinancialData2023 used the \acr{TOC} to identify the pages of
...
[@liExtractingFinancialData2023, p. 20], they use the first 200 lines of text.
:::
...
from the legal text [@hgbHandelsgesetzbuchImBundesgesetzblatt2025, §266]. Actually, there
