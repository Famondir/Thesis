...
```{r loading-table-extraction-datasets, echo=FALSE}
...
```{r table-extraction-llm-performance-total-overview, out.width="100%", fig.height=12}
df_overview %>% 
  ggplot() +
...
```{r table-extraction-llm-performance-numeric-overview, out.width="100%", fig.height=12}
df_overview %>% 
  ggplot() +
...
```{r table-extraction-llm-f1-overview, out.width="100%", fig.height=12}
df_overview %>% 
  ggplot() +
...
```{r table-extraction-llm-performance-total-overview-out-of-company, out.width="100%", fig.height=12}
...
```{r table-extraction-llm-confidence}
...
```{r table-extraction-llm-performance-total-gpt, out.width="100%", fig.height=10}
df_overview_gpt %>% 
  ggplot() +
  geom_boxplot(aes(x = model, y = percentage_correct_total, fill = model_family)) +
  scale_x_discrete(guide = guide_axis(angle = 30)) +
...
```{r table-extraction-llm-performance-numeric-gpt, out.width="100%", fig.height=10}
df_overview_gpt %>% 
  ggplot() +
  geom_boxplot(aes(x = model, y = percentage_correct_numeric, fill = model_family)) +
  scale_x_discrete(guide = guide_axis(angle = 30)) +
...
```{r table-extraction-llm-f1-gpt, out.width="100%", fig.height=10}
df_overview_gpt %>% 
  ggplot() +
  geom_boxplot(aes(x = model, y = NA_F1, fill = model_family)) +
  scale_x_discrete(guide = guide_axis(angle = 30)) +
...
```{r compare-real-table-extraction-by-context-type, out.width="100%", fig.height=12}
bind_rows(
...
```{r table-extraction-llm-confidence-synth-context}
