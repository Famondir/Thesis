...
```{r count_benchmark_documents, echo=echo_flag, warning=warning_flag, message=message_flag}
...
```{r, eval = knitr::is_html_output(), echo=echo_flag, warning=warning_flag, message=message_flag, results='asis', class.chunk='pre-detail'}
cat("<p>You can have a look at the ground truth data unfolding the following details element.</p>")
```

```{r ground_truth_tables_of_interest, eval = knitr::is_html_output(), echo=echo_flag, warning=warning_flag, message=message_flag, class.chunk='hideme'}
DT::datatable(data)
```
...
```{r display_multiple_tables_per_type_and_document, echo=echo_flag, warning=warning_flag, message=message_flag}
