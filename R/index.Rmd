...
acronyms:
  ...
  keys:
    ...
    - shortname: glm
      longname: generalized linear model
    - shortname: regex
      longname: regular expression
    - shortname: RHvB
      longname: Rechnungshof von Berlin
---
...
\huge <span style="font-size: 1.5em;">😊</span> \normalsize
...
* rerun real table analysis after creating more gold standarsd with good working approach
