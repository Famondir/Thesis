...
\clearpage
\newpage
\newgeometry{paper=a3paper, left=2cm, right=2cm, top=2cm, bottom=2cm}

```{r, echo=FALSE, figwidth=16, fig.height=12, out.width="100%", out.height="100%", results="asis", out.extra='angle=0', warning=FALSE}
design = "
ABCD##W
EFGHI#x
JKL####
