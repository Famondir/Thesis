...
```{r metric-plots, echo=echo_flag, warning=warning_flag, message=message_flag}
...
```{r, echo=echo_flag, warning=warning_flag, message=message_flag, out.height="100%", fig.height=12, fig.width=16, warning=FALSE}
design = "
ABCD##W
EFGHI#x
JKL####
